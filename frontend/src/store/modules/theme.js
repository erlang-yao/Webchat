...
const mutations = {
  ...
  setCustomBgImgUrl(state, value) {
    localStorageManager.set('theme-custombgimgurl', value)
    state.customBgImgUrl = value
  }
}
...
const actions = {
  ...
  SET_CUSTOM_BG_IMG_URL({commit}, value) {
    commit('setCustomBgImgUrl', value)
  }
}
